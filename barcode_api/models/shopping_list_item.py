...
class ShoppingListItem(Base, SequentialIdMixin, CreatedAtUpdatedAtMixin):
    """
    ...
    product: Mapped[Optional["Product"]] = relationship("Product", foreign_keys=[product_id], uselist=False)
